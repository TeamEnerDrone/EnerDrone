...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Window_Main_t, stringdata) + ofs \
...
const QMetaObject Window_Main::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Window_Main.data,
      qt_meta_data_Window_Main,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Window_Main.stringdata))
        return static_cast<void*>(const_cast< Window_Main*>(this));
